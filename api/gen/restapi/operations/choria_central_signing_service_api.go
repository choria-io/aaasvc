...
func NewChoriaCentralSigningServiceAPI(spec *loads.Document) *ChoriaCentralSigningServiceAPI {
	return &ChoriaCentralSigningServiceAPI{
		...
		PostSignHandler: PostSignHandlerFunc(func(params PostSignParams) middleware.Responder {
...
func (o *ChoriaCentralSigningServiceAPI) Formats() strfmt.Registry {
	return o.formats
}
...
func (o *ChoriaCentralSigningServiceAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *ChoriaCentralSigningServiceAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *ChoriaCentralSigningServiceAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
